...
- (NSArray *)observableKeypaths {
	return [NSArray arrayWithObjects:@"mode", @"customView", @"labelText", @"labelFont", @"labelColor",
			@"detailsLabelText", @"detailsLabelFont", @"detailsLabelColor", @"progress", @"activityIndicatorColor", @"indicatorStyle", nil];
}
...
- (void)updateUIForKeypath:(NSString *)keyPath {
	if ([keyPath isEqualToString:@"mode"] || [keyPath isEqualToString:@"customView"] ||
		...
		detailsLabel.textColor = self.detailsLabelColor;
    } else if ([keyPath isEqualToString:@"indicatorStyle"]) {
        if (mode == MBProgressHUDModeIndeterminate) {
            [(UIActivityIndicatorView *)indicator setActivityIndicatorViewStyle:self.indicatorStyle];
        }
