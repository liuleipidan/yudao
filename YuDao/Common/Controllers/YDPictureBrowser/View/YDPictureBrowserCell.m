...
@interface YDPictureBrowserCell ()

@property (nonatomic, strong) YDPictureBrowseSouceModel *model;

@end

@implementation YDPictureBrowserCell
...
- (YDBrowseZoomScrollView *)pictureImageScrollView {
    if (!_pictureImageScrollView) {
        _pictureImageScrollView = [[YDBrowseZoomScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
