...
-(void)alertUserCommentView:(UIViewController *)VC{
    NSString *title = @"致开发者的一封信";
    NSString *message = @"有了您的支持才能更好的为您服务，提供更加优质的，更加适合您的App，当然您也可以直接反馈问题给到我们";
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    ...
    YDLog(@"%@",[userDefaults objectForKey:@"appVersion"]);
    YDLog(@"%@",[userDefaults objectForKey:@"userOptChoose"]);
    YDLog(@"%@",[userDefaults objectForKey:@"theDays"]);
