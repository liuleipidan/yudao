...
#import "YDPresentTransition.h"

@implementation YDPresentTransition
//类初始化
+ (instancetype)transitionWithTransitionType:(YDPresentTransitionType)type{
    YDLog(@"transitionWithTransitionType");
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    switch (_type) {
        case YDPresentTransitionTypePresent:
        {
            [self presentAnimation:transitionContext];
            break;
        }
        case YDPresentTransitionTypeDismiss:
        {
...
- (NSTimeInterval )transitionDuration:(id<UIViewControllerContextTransitioning>)transitionContext{
    return _type == YDPresentTransitionTypePresent ? 5 : 1;
}
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    toVC.view.frame = CGRectMake(containerView.width-30, 30, 0, 0);
