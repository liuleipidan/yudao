...
@implementation YDActionSheetToolBar
...
-(void)initialize
{
    ...
    self.cancelButton = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:nil action:nil];
    
    //  Create a title button to show on toolBar for the title you need.
    self.titleButton =[[YDActionSheetTitleBarButtonItem alloc] initWithTitle:nil];
    
    //  Create a done button to show on keyboard to resign it. Adding a selector to resign it.
    self.doneButton = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:nil action:nil];
