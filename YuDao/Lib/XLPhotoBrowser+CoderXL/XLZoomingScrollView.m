...
- (void)initial
{
    ...
    YDCoustomTapGestureRecognizer *singleTapBackgroundView = [[YDCoustomTapGestureRecognizer alloc] initWithTarget:self action:@selector(singleTapBackgroundView:)];
    YDCoustomTapGestureRecognizer *doubleTapBackgroundView = [[YDCoustomTapGestureRecognizer alloc] initWithTarget:self action:@selector(doubleTapBackgroundView:)];
