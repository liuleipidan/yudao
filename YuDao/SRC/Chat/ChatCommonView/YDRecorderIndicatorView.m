...
@interface YDRecorderIndicatorView()
...
@implementation YDRecorderIndicatorView
...
- (UIView *)titleBackgroundView
{
    if (_titleBackgroundView == nil) {
        ...
        [_titleBackgroundView setBackgroundColor:YDColorString(@"#9E282C")];
