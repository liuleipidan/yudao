//
//  YDFunctionSettingViewController.m
//  YuDao
//
...
@interface YDFunctionSettingViewController ()
...
@implementation YDFunctionSettingViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"功能设置"];
    
    self.helper = [[YDSettingHelper alloc] init];
    self.data = self.helper.functionSettingData;
